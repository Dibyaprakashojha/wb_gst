...
//
////	@Autowired
////	private TimeStampRepo timeStampRepo; // Repository for TIMESTAMP_TABLE
////
//	@Autowired
...
//			logger.error("An error occurred while fetching refund records: {}", e.getMessage());
//		}
//
//	}
//
//	@Transactional
//	private void saveAll(List<CrnList> crnData, List<DayCount> dayCountData, String endTime,
...
//
//			// save casedata details of refund api
...
//
//		} catch (Exception e) {
//			throw new RuntimeException("Error Getting In During Saving The All Data");
//		}
//
//	}
//}
